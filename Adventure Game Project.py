...
while True:
    ...
    team_name = random.choice(team_names) # here i used random function to randomly select a name for the team
    ...
    if choice == 1:
        score -= 1
        print("When you start a very hard mission that needs very high skills and you don't have these skills")
        time.sleep(3)
        print("so you went to the town and the police there was finding a group of people to help them catch someone dangerous")
        time.sleep(2)
        print("so you and your team helped them but your brother got stabbed by someone and your father knew but thank God he helped him and cured him and you got punished") 
        time.sleep(4)
        ...
        if choice == 1:
            ...
            if choice == 1:
                ...
                if choice == 1:
                    score -= 1
                    print(f"you went to the {place} and started to steal all the rare things that have a value but the police finds out and took you for prison")
        ...
        if choice == 1:
            ...
            while True:
                try:
                    choice = int(input("1. There is a high way to a mountain \n2. There is a low way to another forest\n"))
                    time.sleep(3)
                    if choice not in [1, 2]:
                        print("Please enter 1 or 2 only")
                        time.sleep(2)
            ...
            if choice == 1:
                ...
                if choice == 1:
                    ...
                    score += 2
                    print("you went for him and kissed him and you and the dog became friends now and started to look for your brother again but now you let your dog sniff the socks to help you after a while you found your brother finally. ")
                    time.sleep(2)
                    print("Congratulations! You have won the game!")
                    print(f"Your score is {score}")
                    time.sleep(3)
